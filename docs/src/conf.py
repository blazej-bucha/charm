...
# Logo
html_logo = "../img/logo/charm-logo.png"

# Favicon
html_favicon = "../img/logo/charm-logo-favicon.png"
...
latex_documents = [
    (master_doc, 'charm.tex', 'CHarm Documentation', author, 'manual'),
]
...
def setup(app):
    app.add_css_file('css/custom_BB.css')
