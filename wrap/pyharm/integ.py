...
* a product of two ``4pi`` fully-normalized surface spherical harmonic
  ...
  .. math::
      ...
      \\lambda) \\, \\bar{Y}_{n_2,m_2}(\\theta, \\lambda) \\,
      \\mathrm{d}\\lambda \\, \\sin(\\theta) \\, \\mathrm{d}\\theta{,} \\quad
      \\theta_1 \\leq \\theta_2{,} \\quad \\lambda_1 \\leq \\lambda_2{.}
...
def pn1m1pn2m2(cltmin, cltmax, n1, m1, n2, m2, pnmj):
    ...
    .. math::
        ...
        \\, \\sin\\theta \\, \\mathrm{d}\\theta{,} \\quad
        \\theta_{\\mathrm{min}} \\leq \\theta_{\\mathrm{max}}{.}
...
def yi1n1m1yi2n2m2(cltmin, cltmax, lonmin, lonmax, i1, n1, m1, i2, n2, m2,
    ...
    .. math::
        ...
        \\bar{P}_{nm}(\\cos\\theta) \\, \\cos(m \\, \\lambda) \\quad
        &\\textrm{if} \\quad i = 0{,}\\\\ \\bar{P}_{nm}(\\cos\\theta) \\,
        \\sin(m \\, \\lambda) \\quad &\\textrm{if} \\quad i = 1{.} \\end{cases}
