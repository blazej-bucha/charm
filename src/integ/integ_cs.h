...
#ifndef __INTEG_CS_H__
#define __INTEG_CS_H__
 ...
 *          u} \cos(a_1 \, u) \, \sin(a_2 \, u) \, \mathrm{d} u
 *
 * \endverbatim
 *
 * for all integers ``0 <= j < nu`` by applying recurrences.  ``nu`` cannot be 
 * zero.
 *
 *
 ...
 *
 * */
extern void CHARM(integ_cs)(REAL u0,
                            REAL du,
                            size_t nu,
                            REAL a1,
                            REAL a2,
