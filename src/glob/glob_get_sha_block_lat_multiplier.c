...
#include "../prec.h"
#include "../simd/simd.h"
#include "glob_get_sha_block_lat_multiplier.h"
/* ------------------------------------------------------------------------- */
...
size_t CHARM(glob_get_sha_block_lat_multiplier)(void)
{
#if HAVE_MPI
    size_t ret = CHARM(glob_sha_block_lat_multiplier);
#else
