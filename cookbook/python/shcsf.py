...
# "from_file_gfc" of the "Shc" class from the "phf.shc" module.
# -----------------------------------------------------------------------------
shcs = phf.shc.Shc.from_file_gfc(shcs_in_file, nmax)
# -----------------------------------------------------------------------------
...
shcs2 = phf.shc.Shc.from_file_bin(shcs_out_file, nmax)
# -----------------------------------------------------------------------------
